...
RUN apt-get install -y node-carto apache2 python-dev python-pyproj python-pil python-pip libapache2-mod-wsgi libjpeg-dev zlib1g-dev libyaml-dev gnupg python python-mapnik apache2 python-dev  python-pyproj python-pil python-pip libapache2-mod-wsgi python-pyproj python-pil python-pip 
RUN apt-get install -y libjpeg-dev zlib1g-dev libyaml-dev wget unzip git python-yaml
RUN apt-get install -y python-requests
RUN apt-get install -y python-gridfs python-pymongo
